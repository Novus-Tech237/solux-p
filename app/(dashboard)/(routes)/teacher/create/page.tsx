...
const CreatePage = () => {
    ...
    const form = useForm<solux.infer<typeof formSchema>>({
    ...
    return ( 
        <div className="max-w-5xl mx-auto flex md:items-center md:justify-center h-full p-6">
            <div>
                ...
                <p className="text-sm text-slate-600">What would you like to name your course? Do not worry you can change this later</p>
                <Form {...form}>
