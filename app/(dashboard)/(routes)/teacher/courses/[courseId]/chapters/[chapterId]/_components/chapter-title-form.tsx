...
export const ChapterTitleForm = ({initialData, courseId, chapterId}:ChapterTitleProps) => {
  ...
  const router = useRouter();
   ...
   return(
       <div className="mt-6 border bg-slate-100 rounded-md p-4">
        <div className="font-medium flex items-center justify-between">Chapter Title
